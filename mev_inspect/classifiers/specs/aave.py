    ...
    def parse_liquidation(
        ...
        if debt_transfer is not None and received_transfer is not None:
            ...
            return Liquidation(
                ...
                timestamp=liquidation_trace.block_timestamp,
                trace_address=liquidation_trace.trace_address,
                status=liquidation_trace.error is None,
                ...
                gas_price=liquidation_trace.gas,
                gas_usage=liquidation_trace.gas_used,
                block_position=liquidation_trace.transaction_position,
            )
